...
const items: ScrollItem[] = [
  {
    ...
    videoUrl: "/media/ritual/bath-salt.mp4",
    imageUrl: "/media/box/luaz-box-open.webp",
  },
  {
    id: "02",
    ...
    videoUrl: "/media/ritual/essential-oil.mp4",
    imageUrl: "/media/box/luaz-box-detail.webp",
  },
  {
    id: "03",
    name: "Chamomile Tea",
    ...
    videoUrl: "/media/ritual/tea.mp4",
    imageUrl: "/media/products/tea.webp",
  },
  {
    id: "04",
    name: "Hemp Socks",
    ...
    videoUrl: "/media/ritual/socks.mp4",
    imageUrl: "/media/box/luaz-box-detail.webp",
  }
];
